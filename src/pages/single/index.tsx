...
import RenderSidebarTwo from 'src/components/SingleItem/singleSections/renderSidebarTwo';
import SeeMoreSection from 'src/components/SingleItem/singleSections/seeMoreSection';
import BreadcrumbSection from 'src/components/SingleItem/singleSections/breadcrumbSection';
import BottomListSection from 'src/components/SingleItem/singleSections/bottomListSection';
    ...
    <div>
      <Container>
        <div className="grid grid-cols-1 justify-items-center p-4">
          ...
          <main className="container max-w-7xl relative z-10 mt-12 flex flex-col lg:flex-row lg:gap-x-8 divide-x-2 divide-gray-100">
            <div className="w-full lg:w-3/5 xl:w-2/3 space-y-12 lg:space-y-16">
              {/* <NewSectionTop /> */}
              <SectionTop />
              {/* <SectionDetail /> */}
          ...
          <div className="w-full max-w-7xl my-16 space-y-24">
            <SeeMoreSection />
            <BottomListSection />
          </div>
        </div>
