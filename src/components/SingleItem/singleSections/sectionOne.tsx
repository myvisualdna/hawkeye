  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-between">
        <div>
          <h1 className="font-black text-3xl font-display text-gray-800">
      ...
      <div className="flex my-2">
        <h4 className="font-display text-base font-regular text-gray-400 mr-2">
          2 Bedroom
        </h4>
        <div className="font-display text-base font-regular text-gray-400 mr-2">
          •
        </div>
        <h4 className="font-display text-base font-regular text-gray-400 mr-2">
          1 Bathroom
