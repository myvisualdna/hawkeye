  ...
  const renderModalPhotos = () => {
    return (
      <Dialog
        ...
        as="div"
        className="fixed inset-0 z-10 overflow-y-auto dark bg-neutral-800 text-neutral-200 hiddenScrollbar"
        onClose={onClose}
        open={isOpen}
      >
        <div className="min-h-screen px-4 text-center">
          ...
          <div
            ...
            className="relative left-1 top-2 md:top-4 md:left-4 z-max flex justify-end"
          >
            <ButtonClose className=" sm:w-11 sm:h-11 z-20" onClick={onClose} />
          </div>
