...
import MobileSearchMenuTop from 'src/components/SearchPage/SearchComponents/mobileSearchMenuTop';
...
const NavigationSearch = (props: Props) => {
  return (
    <div>
      <header aria-label="Site Header" className="bg-white">
        <div className="mx-auto flex h-16 max-w-screen-3xl items-center gap-8 px-4 sm:px-6 lg:px-8 z-30">
      ...
      <div className="mx-auto hidden md:flex h-16 max-w-screen-3xl items-center gap-8 px-4 sm:px-6 lg:px-8 z-20 sticky">
