        ...
        <div>
          ...
          <div>
            ...
            >
              ...
              {address.title} 
              <div
              className="text-gray-800 hover:gray-800 text-sm lg:text-sm transition duration-100"
            >
            ...
            <div className="flex items-end gap-2">
              <span className="text-gray-800 text-base lg:text-lg font-bold font-display">{priceFormatter.format(price)}</span>
            </div>
          </div>
        </div>
      </Link>
