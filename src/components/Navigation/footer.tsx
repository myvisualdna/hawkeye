  ...
  return (
    <div>
      <footer className="bg-gray-50">
        <div className="px-4 py-16 mx-auto max-w-screen-xl space-y-12 sm:px-6 lg:px-8">
          <div className="sm:items-center sm:justify-between sm:flex">
            <span className="block w-32 h-10 bg-gray-200 rounded-lg"></span>

            <div className="flex mt-8 text-gray-500 space-x-6 sm:mt-0">
              <a
          ...
          <div className="pt-12 border-t border-gray-100 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
